...
class TeamSummary(ctk.CTkFrame):
    ...
    def add_player_box(self, player):
        ...
        box_frame = ctk.CTkFrame(self.scroll_frame, fg_color="#B0B050", border_color="black", border_width=5, corner_radius=0,
        ...
        stats_button = ctk.CTkButton(box_frame, text="View Stats", font=("Arial", 20), fg_color="#900090",
                                     border_color="black", border_width=5, corner_radius=0, command=lambda player = player, incoming = "Team Summary": self.master.view_stats(player, incoming),
                                     width=130, height=60)
        ...
        remove_button = ctk.CTkButton(box_frame, text="Remove", font=("Arial", 20), fg_color="#900000",
                                   border_color="black", border_width=5, corner_radius=0, command=lambda player = player, box = box_frame: self.remove_player(player, box),
                                   width=130,
                                   height=60)
    ...
    def add_player(self, player):
        ...
        if len(self.master.team) >= 15:
            ...
            self.player_count.configure(text = "Players: " + str(len(self.master.team)) + "/15")
